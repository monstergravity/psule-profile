...
interface PolaroidCardProps {
    ...
    onDownload?: (styleKey: string) => void;
}
...
const PolaroidCard: React.FC<PolaroidCardProps> = ({ imageUrl, caption, styleKey, status, error, onRegenerate, onDownload }) => {
    ...
    return (
        <div className="bg-neutral-100 dark:bg-neutral-100 !p-4 !pb-16 flex flex-col items-center justify-start aspect-[3/4] w-80 max-w-full rounded-md shadow-lg relative transform transition-transform duration-300 hover:scale-105">
            {cardInnerContent}
        </div>
    );
};
